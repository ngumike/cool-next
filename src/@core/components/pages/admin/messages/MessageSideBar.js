    ...
    >
      ...
      <Box sx={{ p: 5 }}>
        <form onSubmit={formik.handleSubmit}>
          ...
          <FormControl fullWidth sx={{ mb: 6 }}>
            <TextField
              error={Boolean(formik.touched.smsc && formik.errors.smsc)}
              helperText={formik.touched.smsc && formik.errors.smsc}
              fullWidth
              required
              label='SMSC'
              name='smsc'
              ...
              onBlur={formik.handleBlur}
              onChange={formik.handleChange}
              value={formik.values.smsc}
            />
          </FormControl>
          <FormControl fullWidth sx={{ mb: 6 }}>
            <TextField
              error={Boolean(formik.touched.scts && formik.errors.scts)}
              helperText={formik.touched.scts && formik.errors.scts}
              fullWidth
              required
              label='SCTS'
              name='scts'
